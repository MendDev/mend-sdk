...
class MendSdk {
  constructor(opts) {
    ...
    if (
      !(opts === null || opts === void 0 ? void 0 : opts.apiEndpoint) ||
      !(opts === null || opts === void 0 ? void 0 : opts.email) ||
      !(opts === null || opts === void 0 ? void 0 : opts.password)
    ) {
  ...
  async completeLogin(res) {
    ...
    if (this.orgId !== undefined) {
      ...
      if (!this.availableOrgs) {
        ...
        this.availableOrgs = Array.isArray(orgs === null || orgs === void 0 ? void 0 : orgs.payload)
          ? orgs.payload
          : (_a = orgs === null || orgs === void 0 ? void 0 : orgs.payload) === null ||
              _a === void 0
            ? void 0
            : _a.orgs;
      }
  ...
  async getProperty(key, signal) {
    ...
    return (_b =
      (_a = props === null || props === void 0 ? void 0 : props.payload) === null || _a === void 0
        ? void 0
